	...
	theme: {
		...
		extend: {
			colors: {
				...
				banking: {
					green: 'hsl(var(--banking-green))',
					'green-foreground': 'hsl(var(--banking-green-foreground))',
					orange: 'hsl(var(--banking-orange))',
					'orange-foreground': 'hsl(var(--banking-orange-foreground))',
			...
			transitionProperty: {
				'banking': 'var(--transition-banking)'
			},
			borderRadius: {
				lg: 'var(--radius)',
